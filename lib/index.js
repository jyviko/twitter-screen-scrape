...
(function() {
  ...
  getPostElements = function(username, since, till, startingId) {
    return request.get({
  ...
  TwitterPosts = (function(superClass) {
    ...
    function TwitterPosts(arg) {
      this.username = arg.username, this.since = arg.since, this.till = arg.till, this._minPostId = arg._minPostId, this.retweets = arg.retweets;
    ...
    TwitterPosts.prototype._read = function() {
      ...
      hasMorePosts = void 0;
      lastPost = void 0;
      return getPostElements(this.username, this.since, this.till, this._minPostId).then(function(response) {
        var html;
        ...
        return function($) {
          var action, element, hasEmitted, i, id, idBig, isRetweet, j, k, len, len1, len2, pic, pics, post, ref, wrapper;
          hasEmitted = false;
          ref = $('.original-tweet');
